...
@section('title', 'Edit Job Post - Sarkari Result Admin')
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Edit Job Post Information</h3>
        </div>
        
        <form id="editJobPostForm" action="{{ route('admin.job-posts.update', $jobPost) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('organization') is-invalid @enderror" id="organization" name="organization" 
                           value="{{ old('organization', $jobPost->organization) }}" required>
                    @error('organization')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('short_description') is-invalid @enderror" id="short_description" name="short_description" 
                              rows="3" maxlength="500">{{ old('short_description', $jobPost->short_description) }}</textarea>
                    <small class="form-text text-muted">Maximum 500 characters. This will be shown in job listings.</small>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" 
                              rows="8" required>{{ old('description', $jobPost->description) }}</textarea>
                    @error('description')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('total_posts') is-invalid @enderror" id="total_posts" name="total_posts" 
                                   value="{{ old('total_posts', $jobPost->total_posts) }}" min="1">
                            @error('total_posts')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('application_fee') is-invalid @enderror" id="application_fee" name="application_fee" 
                                   value="{{ old('application_fee', $jobPost->application_fee) }}" min="0" step="0.01">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('start_date') is-invalid @enderror" id="start_date" name="start_date" 
                                   value="{{ old('start_date', $jobPost->start_date?->format('Y-m-d')) }}">
                            @error('start_date')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('end_date') is-invalid @enderror" id="end_date" name="end_date" 
                                   value="{{ old('end_date', $jobPost->end_date?->format('Y-m-d')) }}">
                            @error('end_date')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('exam_date') is-invalid @enderror" id="exam_date" name="exam_date" 
                                   value="{{ old('exam_date', $jobPost->exam_date?->format('Y-m-d')) }}">
                            @error('exam_date')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="url" class="form-control @error('official_website') is-invalid @enderror" id="official_website" name="official_website" 
                                   value="{{ old('official_website', $jobPost->official_website) }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="notification_pdf">Notification PDF URL</label>
                            <input type="url" class="form-control @error('notification_pdf') is-invalid @enderror" id="notification_pdf" name="notification_pdf" 
                                   value="{{ old('notification_pdf', $jobPost->notification_pdf) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="url" class="form-control @error('application_link') is-invalid @enderror" id="application_link" name="application_link" 
                           value="{{ old('application_link', $jobPost->application_link) }}">
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        if (xhr.status === 422) {
                            ...
                            toastr.error('An error occurred while updating the job post.');
                        }
                    },
                    complete: function() {
