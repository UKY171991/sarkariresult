...
@section('title', 'Create Answer Key - Sarkari Result Admin')

@section('content_header')
    <div class="row">
        <div class="col-sm-6">
            <h1>Create New Answer Key</h1>
        </div>
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Answer Key Information</h3>
        </div>
        
        <form id="createAnswerKeyForm" action="{{ route('admin.answer-keys.store') }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-primary" id="submitBtn">
                    <i class="fas fa-save"></i> Create Answer Key
                </button>
                <a href="{{ route('admin.answer-keys.index') }}" class="btn btn-secondary">
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#createAnswerKeyForm').on('submit', function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        toastr.success('Answer key created successfully!');
                        setTimeout(function() {
                    ...
                    error: function(xhr) {
                        if (xhr.status === 422) {
                            ...
                            toastr.error('An error occurred while creating the answer key.');
                        }
                    },
                    complete: function() {
