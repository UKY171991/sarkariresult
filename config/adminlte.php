...
return [
    ...
    */
    ...
    'menu' => [
        ...
        ['header' => 'Content Management', 'role' => 'admin'],
        [
            'text' => 'Categories',
        ...
        [
            'text' => 'Answer Keys',
            'route' => 'admin.answer-keys.index',
            'icon' => 'fas fa-fw fa-file-alt',
            'role' => 'admin',
        ],
        
        ['header' => 'System', 'role' => 'admin'],
        [
            'text' => 'My Profile',
    ...
    |--------------------------------------------------------------------------
    |
    | Here we can configure the user menu that appears in the top-right corner
